import { A as AstroError, w as UnknownContentCollectionError, b as createComponent, x as RenderUndefinedEntryError, r as renderTemplate, y as unescapeHTML, z as renderUniqueStylesheet, B as renderScriptElement, C as createHeadAndContent, d as renderComponent, g as AstroUserError } from './astro/server_BhqBo4YN.mjs';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_ByUmG5MB.mjs');
...
const __vite_import_meta_env__ = {"ASSETS_PREFIX": undefined, "BASE_URL": "/", "DEV": false, "MODE": "production", "PROD": true, "SITE": "https://linklyposintegrations.github.io/pos.faq/", "SSR": true};
...
function createGetCollection({
  ...
  return async function getCollection(collection, filter) {
    ...
    if (collection in contentCollectionToEntryMap) {
      ...
      const { default: imageAssetMap } = await import('./content-assets_CjNMRm_O.mjs');
      const result = [];
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_mqCcIBHL.mjs').then(n => n._);
...
async function renderEntry(entry) {
  ...
  if (entry.deferredRender) {
    try {
      const { default: contentModules } = await import('./content-modules_BJF9zF6M.mjs');
...
const starlightConfig = {"tableOfContents":{"minHeadingLevel":2,"maxHeadingLevel":3},"editLink":{},"sidebar":[{"label":"FAQs","translations":{},"collapsed":false,"items":[{"label":"Getting Started","translations":{},"slug":"guides/gettingstarted","attrs":{}},{"label":"API Overview","translations":{},"slug":"guides/apigeneral","attrs":{}},{"label":"OnPrem TCPIP/ActiveX","translations":{},"slug":"guides/onprem","attrs":{}},{"label":"Cloud","translations":{},"slug":"guides/cloud","attrs":{}},{"label":"MPOS","translations":{},"slug":"guides/mpos","attrs":{}},{"label":"Integration support","translations":{},"slug":"guides/integrationsupport","attrs":{}},{"label":"Accreditation support","translations":{},"slug":"guides/accreditationsupport","attrs":{}}]},{"label":"Quick Actions","translations":{},"collapsed":false,"items":[{"label":"Links & Downloads","translations":{},"slug":"guides/downloads","attrs":{}}]}],"head":[],"lastUpdated":false,"pagination":true,"favicon":{"href":"/favicon.svg","type":"image/svg+xml"},"components":{"Search":"@astrojs/starlight/components/Search.astro"},"titleDelimiter":"|","credits":false,"pagefind":{"ranking":{"pageLength":0.1,"termFrequency":0.1,"termSaturation":2,"termSimilarity":9}},"title":{"en":"POS FAQ"},"isMultilingual":false,"defaultLocale":{"label":"English","lang":"en","dir":"ltr"}};

const project = {"build":{"format":"directory"},"root":"file:///C:/Users/Lakshan.Perera/dev/faq/","srcDir":"file:///C:/Users/Lakshan.Perera/dev/faq/src/","trailingSlash":"ignore"};
...
export { booleanType as A, BuiltInDefaultLocale as B, undefinedType as C, DEFAULT_OUTPUT_FORMAT as D, renderEntry as E, VALID_SUPPORTED_FORMATS as V, getCollectionPathFromRoot as a, getCollectionPath as b, DEFAULT_HASH_PROPS as c, getCollection as d, stripTrailingSlash as e, stripLeadingSlash as f, getEntry as g, stripHtmlExtension as h, isRemotePath as i, joinPaths as j, ensureHtmlExtension as k, ensureTrailingSlash as l, pickLang as m, stripLeadingAndTrailingSlashes as n, ensureLeadingSlash as o, project as p, stripExtension as q, DeprecatedLabelsPropProxy as r, starlightConfig as s, objectType as t, useTranslations as u, stringType as v, enumType as w, unionType as x, recordType as y, arrayType as z };
