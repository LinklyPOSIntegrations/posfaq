...
async function createRegexEngine(engine) {
  if (engine === "javascript")
    return [undefined][0];
  return [(await import('./engine-oniguruma_yhWVE7DZ.mjs')).createOnigurumaEngine(import('./wasm_CmTHlobv.mjs'))][0];
}
