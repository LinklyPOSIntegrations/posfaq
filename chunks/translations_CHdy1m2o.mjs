import { A as AstroError, w as UnknownContentCollectionError, a as createComponent, x as RenderUndefinedEntryError, y as escape$1, z as unescapeHTML, d as renderTemplate, B as renderUniqueStylesheet, C as renderScriptElement, D as createHeadAndContent, r as renderComponent, g as AstroUserError } from './astro/server_wPAoJWlo.mjs';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_BP68rbos.mjs');
...
const __vite_import_meta_env__ = {"ASSETS_PREFIX": undefined, "BASE_URL": "/posfaq/", "DEV": false, "MODE": "production", "PROD": true, "SITE": undefined, "SSR": true};
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_Le7lQN8Q.mjs').then(n => n._);
...
async function renderEntry(entry) {
  ...
  if (entry.deferredRender) {
    try {
      const { default: contentModules } = await import('./content-modules_BNGFcMqR.mjs');
